...
class MyCustomWidget(QtWidgets.QWidget):
    def __init__(self, t1, t2, t3, parent=None):
        ...
        self.label_1
        self.label_1.setStyleSheet("QLabel { background-color : white; padding: 10px 0px 0px 0px;}")
        self.label_2 = QtWidgets.QLabel(t2)
        self.label_2.setAlignment(QtCore.Qt.AlignHCenter)
        self.label_2.setStyleSheet("QLabel { background-color : white; padding: 5px 0px 5px 0px;}")
        self.label_3 = QtWidgets.QLabel(t3)
        self.label_3.setAlignment(QtCore.Qt.AlignHCenter)
        self.label_3.setStyleSheet("QLabel { background-color : white; padding: 0px 0px 10px 0px;}")
